package com.konosuba.spring.redis.service;
...
public interface RedisService {
    ...
    /**
     * 将当前数据库的key 移动到数据库db中
     * @param key 移动的 key
     * @param dbIndex 目标数据库，移动的key
     * @return 成功返回true
     */
     ...
     *
     * @param key 查看的key
     * @param timeUnit TimeUnit的枚举类，单位
     * @return 返回时间
     */
    ...
    /**
     * 修改 key 的名称
     * @param oldKey key原来的名称
     * @param newKey key新的名称
     */
     ...
     * @return key对应的值的集合
     */
    List<Object> mutiGet(Collection<String> keys);
    ...
    /**
     * 用value参数覆写给的key所存储的字符串值，从偏移量offset开始
     * @param key key
     * @param value 覆写的参数值
